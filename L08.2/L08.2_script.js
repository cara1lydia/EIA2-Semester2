...
(function (Beach) {
    ...
    function drawSeagull(_position) {
        let x = (Math.random() * 30) + _position.x;
        let y = (Math.random() * 30) + _position.y;
        crc2.beginPath();
    ...
    function drawRocks(_position, _min, _max, _colorLow, _colorHigh) {
        let stepMin = 20;
        let stepMax = 50;
        let x = 0;
        crc2.save();
    ...
    function drawSand(_position) {
        let gradient = crc2.createLinearGradient(0, 0, 0, window.innerHeight);
    ...
    function drawPeople(_position, _rotation) {
        crc2.strokeStyle = "rgb(0, 0, 0, 0.5";
        crc2.save();
        crc2.translate(_position.x, _position.y);
...
//# sourceMappingURL=L08.2_script.js.map